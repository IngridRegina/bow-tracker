...
const T = {
  en: {
    ...
    dragonTitle: "Dragon coins",
    dragonIntro: "A member finishes a tournament in the top 100 and the game sends their dragon coins to the clan automatically; the leader then hands them back out to whoever earned them. This tab tracks both sides — what came in and what has been paid out.",
    dragonReconTitle: "Payouts — has everyone been paid?",
    dragonReconIntro: "What each member earned, against what has been distributed back to them. Anyone still owed is highlighted and sorted to the top.",
    dragonReconEarned: "earned by members",
    dragonReconDistributed: "distributed so far",
    dragonReconOutstanding: "still to distribute",
    dragonAllPaid: "Everyone has been paid what they earned.",
  ...
  es: {
    ...
    dragonTitle: "Monedas de dragón",
    dragonIntro: "Cuando un miembro termina un torneo entre los 100 primeros, el juego envía sus monedas de dragón al clan automáticamente; luego el líder se las reparte a quien las ganó. Esta pestaña sigue ambas caras — lo que entró y lo que ya se ha repartido.",
    dragonReconTitle: "Reparto — ¿ha cobrado todo el mundo?",
    dragonReconIntro: "Lo que ganó cada miembro frente a lo que se le ha repartido. A quien todavía se le debe aparece resaltado y ordenado arriba.",
    dragonReconEarned: "ganadas por los miembros",
    dragonReconDistributed: "repartidas hasta ahora",
    dragonReconOutstanding: "por repartir",
    dragonAllPaid: "Todos han cobrado lo que ganaron.",
